$(function () {
    ...
    $("#showOdemeler").click(function () {
        $(this).addClass("active");
        $("#showAbonelikler").removeClass("active");
        $("#odemeler").addClass("active");
        $("#abonelikler").removeClass("active");
    });
    $("#showAbonelikler").click(function () {
        $(this).addClass("active");
        $("#showOdemeler").removeClass("active");
        $("#abonelikler").addClass("active");
        $("#odemeler").removeClass("active");
    });
    ...
    navbar.find(".nav-item").click(function () {
